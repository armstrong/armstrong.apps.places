...
[build_package(dirpath, dirnames, filenames) for dirpath, dirnames, filenames
        in os.walk('armstrong/apps/places')]

setup(
    name='armstrong.apps.places',
    version='0.1',
    description='Provides geographic places for a Django site.',
    author='Bay Citizen & Texas Tribune',
    author_email='dev@armstrongcms.org',
    url='http://github.com/armstrongcms/armstrong.apps.places/',
    packages=packages,
